    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if phase == 'val' and epoch_acc > best_acc:
                best_acc = epoch_acc
                best_model_wts = copy.deepcopy(model.state_dict())
                torch.save(best_model_wts, os.path.join(models_dir, model_name))
        print()
...
torch.save(model_ft.state_dict(), os.path.join(models_dir,model_name))
...
plt.legend(loc='best')
name_fig_loss = sys.argv[3] #'train_val_loss_plot.png'
plt.savefig(os.path.join(figures_dir, name_fig_loss))
...
plt.legend(loc='best')
name_fig_acc= sys.argv[4] #'train_val_acc_plot.png'
plt.savefig(os.path.join(figures_dir,name_fig_acc ))
